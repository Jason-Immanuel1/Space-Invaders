...
public class Explosion{
    public void playExplosion(Pane root, double x, double y) {
        ...
        Image explOne = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/sprites/explOne.png")));
        Image explTwo = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/sprites/explTwo.png")));
        Image explThree = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/sprites/explThree.png")));
